package ShortenTheSpire.Patches;

import ShortenTheSpire.ShortenTheSpireMod;
...
public class PostLoadLocalizationPatch {
    ...
    {
        for (Settings.GameLanguage lang : ShortenTheSpireMod.SupportedLanguages)
        {
            if (lang.equals(Settings.language))
            {
                ShortenTheSpireMod.PostLoadLocalizationStrings(languagePack);
                break;
            }
        }
    }
